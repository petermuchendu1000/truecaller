...
public final class RetryImMessageWorker extends androidx.work.Worker {
    public final n11.l a;
    public final qc3.bar b;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RetryImMessageWorker(@org.jetbrains.annotations.NotNull android.content.Context context, @org.jetbrains.annotations.NotNull androidx.work.WorkerParameters workerParameters, @org.jetbrains.annotations.NotNull n11.l lVar, @org.jetbrains.annotations.NotNull qc3.bar barVar) {
    ...
    public final nd.t doWork() {
        ...
        ((y12.v) ((xd0.qux) barVar.get()).a()).v(2, new org.joda.time.DateTime(d));
        ((y12.v) ((xd0.qux) barVar.get()).a()).v(9, new org.joda.time.DateTime(d));
        nd.s a2 = nd.t.a();
