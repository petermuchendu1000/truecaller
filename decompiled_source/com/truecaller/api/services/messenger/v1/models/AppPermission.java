...
public enum AppPermission implements com.google.protobuf.Internal.EnumLite {
    NO_PERMISSION(0),
    ...
    public static final int ALL_PERMISSIONS_VALUE = 63;
    ...
    private static final com.google.protobuf.Internal.EnumLiteMap<com.truecaller.api.services.messenger.v1.models.AppPermission> internalValueMap = new java.lang.Object();
    ...
    public static com.truecaller.api.services.messenger.v1.models.AppPermission forNumber(int i) {
        if (i != 0) {
            if (i != 1) {
                if (i != 2) {
                    if (i != 4) {
    ...
    public static com.google.protobuf.Internal.EnumLiteMap<com.truecaller.api.services.messenger.v1.models.AppPermission> internalGetValueMap() {
    ...
    public static com.truecaller.api.services.messenger.v1.models.AppPermission valueOf(int i) {
        return forNumber(i);
    }
}
