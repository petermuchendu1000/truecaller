...
public final class l extends ff3.g implements kotlin.jvm.functions.Function2 {
    ...
    public l(com.truecaller.data.country.n nVar, df3.bar barVar) {
        super(2, barVar);
        this.x = nVar;
    }

    public final df3.bar create(java.lang.Object obj, df3.bar barVar) {
        return new com.truecaller.data.country.l(this.x, barVar);
    }
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object obj) {
        ...
        if (countryListDto != null && (bazVar = countryListDto.suggestedCountryList) != null && (list = bazVar.b) != null) {
            return list;
        }
