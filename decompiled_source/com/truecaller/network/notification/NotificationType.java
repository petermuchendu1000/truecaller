...
public enum NotificationType {
    ...
    public static com.truecaller.network.notification.NotificationType valueOf(int i) {
        for (com.truecaller.network.notification.NotificationType notificationType : values()) {
