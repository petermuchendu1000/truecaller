...
public final class BizRightImageWithTextBannerView extends com.google.android.material.card.MaterialCardView implements sg0.baz {
    ...
    public BizRightImageWithTextBannerView(android.content.Context context) {
    ...
    public final void g(java.lang.String str) {
        ...
        com.bumptech.glide.baz.e(getContext()).q(str).P(getBinding().d);
    }

    @org.jetbrains.annotations.NotNull
    public final fi0.k getBinding() {
        return (fi0.k) this.j.getValue();
    }
    ...
    public void setBannerClickListener(@org.jetbrains.annotations.Nullable final java.lang.String str) {
        final int i = 0;
        setOnClickListener(new android.view.View.OnClickListener(this) { // from class: sg0.a
            public final /* synthetic */ com.truecaller.bizmon.banner.mvp.imageWithText.BizRightImageWithTextBannerView b;
            ...
            public final void onClick(android.view.View view) {
                ...
                com.truecaller.bizmon.banner.mvp.imageWithText.BizRightImageWithTextBannerView bizRightImageWithTextBannerView = this.b;
                switch (i2) {
                    case 0:
                        int i3 = com.truecaller.bizmon.banner.mvp.imageWithText.BizRightImageWithTextBannerView.l;
                        ((rg0.baz) bizRightImageWithTextBannerView.getPresenter()).f2(str2);
                        return;
                    default:
                        int i4 = com.truecaller.bizmon.banner.mvp.imageWithText.BizRightImageWithTextBannerView.l;
                        ((rg0.baz) bizRightImageWithTextBannerView.getPresenter()).f2(str2);
                        return;
                }
            }
        ...
        final int i2 = 1;
        getBinding().b.setOnClickListener(new android.view.View.OnClickListener(this) { // from class: sg0.a
            public final /* synthetic */ com.truecaller.bizmon.banner.mvp.imageWithText.BizRightImageWithTextBannerView b;
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public BizRightImageWithTextBannerView(android.content.Context context, android.util.AttributeSet attributeSet) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public BizRightImageWithTextBannerView(android.content.Context context, android.util.AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        kotlin.jvm.internal.Intrinsics.checkNotNullParameter(context, "context");
        this.j = kotlin.LazyKt.lazy(new sd.bar(2, context, this));
        this.k = new s20.bar(10);
        setRadius(32.0f);
    ...
    public /* synthetic */ BizRightImageWithTextBannerView(android.content.Context context, android.util.AttributeSet attributeSet, int i, int i2, kotlin.jvm.internal.DefaultConstructorMarker defaultConstructorMarker) {
