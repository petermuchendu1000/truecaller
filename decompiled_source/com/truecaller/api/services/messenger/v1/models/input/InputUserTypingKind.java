...
public enum InputUserTypingKind implements com.google.protobuf.Internal.EnumLite {
    TYPING(0),
    VIDEO(1),
    VIDEO_UPLOADING(8),
    IMAGE(2),
    ...
    private static final com.google.protobuf.Internal.EnumLiteMap<com.truecaller.api.services.messenger.v1.models.input.InputUserTypingKind> internalValueMap = new java.lang.Object();
    private final int value;

    InputUserTypingKind(int i) {
        this.value = i;
    }

    public static com.truecaller.api.services.messenger.v1.models.input.InputUserTypingKind forNumber(int i) {
        switch (i) {
            case 0:
                return TYPING;
            case 1:
    ...
    public static com.google.protobuf.Internal.EnumLiteMap<com.truecaller.api.services.messenger.v1.models.input.InputUserTypingKind> internalGetValueMap() {
    ...
    public static com.truecaller.api.services.messenger.v1.models.input.InputUserTypingKind valueOf(int i) {
        return forNumber(i);
    }
}
