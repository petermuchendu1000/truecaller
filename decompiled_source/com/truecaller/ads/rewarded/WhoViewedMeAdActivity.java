...
@kotlin.Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, d2 = {"Lcom/truecaller/ads/rewarded/WhoViewedMeAdActivity;", "Landroidx/appcompat/app/AppCompatActivity;", "<init>", "()V", "truecaller_googlePlayRelease"}, k = 1, mv = {2, 2, 0}, xi = 48)
/* loaded from: /home/user/tc_decoded/classes5.dex */
public final class WhoViewedMeAdActivity extends com.truecaller.ads.rewarded.Hilt_WhoViewedMeAdActivity {
    public static final /* synthetic */ int f0 = 0;
    public qc3.bar d0;
    public qc3.bar e0;

    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.truecaller.ads.rewarded.Hilt_WhoViewedMeAdActivity
    public final void onCreate(android.os.Bundle bundle) {
        com.truecaller.analytics.technical.AppStartTracker.onActivityCreate(this);
        super.onCreate(bundle);
        ge0.i.m(getOnBackPressedDispatcher(), this, new z90.c(this, 1), 2);
        e.d.a(this, new d3.qux(1553145824, new z90.d(this, 0), true));
        v0(getIntent());
    }
    ...
    public final void t0(int i, v2.n nVar) {
        ...
        if (nVar.P(i2, z)) {
            ...
            nVar2 = nVar;
            k5.g.b((kotlin.jvm.functions.Function1) M, (j3.q) null, (kotlin.jvm.functions.Function1) null, nVar2, 6, 6);
        } else {
            nVar2 = nVar;
            nVar2.S();
        }
    ...
    public final void v0(android.content.Intent intent) {
        ...
        if (intent != null && (extras = intent.getExtras()) != null && (string = extras.getString("custom_data")) != null) {
            qc3.bar barVar = this.e0;
            if (barVar != null) {
                if (((z90.b) ((z90.bar) barVar.get())).e("WHO_VIEWED_ME")) {
                    qc3.bar barVar2 = this.e0;
                    if (barVar2 != null) {
                        ((z90.b) ((z90.bar) barVar2.get())).c(this, "WHO_VIEWED_ME", string, false, new z90.c(this, 0));
                        return;
                    } else {
                        kotlin.jvm.internal.Intrinsics.n("rewardedAdManager");
                        throw null;
                    }
                }
                finish();
