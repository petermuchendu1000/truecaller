...
public abstract class Hilt_NotificationTrampolineActivity extends androidx.appcompat.app.AppCompatActivity implements bd3.qux {
    ...
    public Hilt_NotificationTrampolineActivity() {
        addOnContextAvailableListener(new v32.bar(this, 7));
    }
