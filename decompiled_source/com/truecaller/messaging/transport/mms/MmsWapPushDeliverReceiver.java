...
public final class MmsWapPushDeliverReceiver extends android.content.BroadcastReceiver implements fg3.e0 {
    ...
    public final void a(android.content.Context context, android.content.Intent intent) {
        ...
        if (!this.a) {
            synchronized (this.b) {
                try {
                    if (!this.a) {
                        tx.w wVar = ((k42.l) o40.bar.k(context)).H.b.a;
                        this.c = (kotlin.coroutines.CoroutineContext) wVar.P.get();
                        this.d = cd3.baz.a(wVar.y3);
                        this.a = true;
                    }
    ...
    public final void onReceive(android.content.Context context, android.content.Intent intent) {
        ...
        kotlin.coroutines.CoroutineContext coroutineContext = this.c;
        if (coroutineContext != null) {
            fg3.h0.J(this, coroutineContext, (fg3.f0) null, new ja1.d(this, intent, null, 16), 2);
        } else {
            kotlin.jvm.internal.Intrinsics.n("ioContext");
            throw null;
        }
