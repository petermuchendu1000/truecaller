...
public enum Event$EventBatch$BatchedEvent$PayloadCase {
    MESSAGE_SENT(2),
    REPORT_SENT(3),
    REACTION_SENT(4),
    GROUP_CREATED(5),
    ...
    Event$EventBatch$BatchedEvent$PayloadCase(int i) {
        this.value = i;
    }

    public static com.truecaller.api.services.messenger.v1.events.Event$EventBatch$BatchedEvent$PayloadCase forNumber(int i) {
        if (i != 0) {
            if (i != 998) {
                switch (i) {
                    case 2:
    ...
    public static com.truecaller.api.services.messenger.v1.events.Event$EventBatch$BatchedEvent$PayloadCase valueOf(int i) {
        return forNumber(i);
    }
}
