...
public enum UserTypingKind implements com.google.protobuf.Internal.EnumLite {
    TYPING(0),
    VIDEO(1),
    VIDEO_UPLOADING(8),
    IMAGE(2),
    ...
    private static final com.google.protobuf.Internal.EnumLiteMap<com.truecaller.api.services.messenger.v1.models.UserTypingKind> internalValueMap = new java.lang.Object();
    ...
    public static com.truecaller.api.services.messenger.v1.models.UserTypingKind forNumber(int i) {
        switch (i) {
            case 0:
                return TYPING;
            case 1:
    ...
    public static com.google.protobuf.Internal.EnumLiteMap<com.truecaller.api.services.messenger.v1.models.UserTypingKind> internalGetValueMap() {
    ...
    public static com.truecaller.api.services.messenger.v1.models.UserTypingKind valueOf(int i) {
        return forNumber(i);
    }
}
