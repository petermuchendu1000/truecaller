...
public abstract class Hilt_NotificationSettingsActivity extends androidx.appcompat.app.AppCompatActivity implements bd3.qux {
    ...
    public Hilt_NotificationSettingsActivity() {
        addOnContextAvailableListener(new ps2.baz(this, 9));
    }
